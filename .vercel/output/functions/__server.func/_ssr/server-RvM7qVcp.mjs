...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DHAJykIL.mjs");
...
const manifest = {
  "8f5c6d438bb42d34f78a3d40aabd00c8600598a6e046d3ca5d9b0eff21ab1c02": {
    functionName: "fetchSanity_createServerFn_handler",
    importer: () => import("./sanity.server-COrGc2y8.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-8Sc-kGY-.mjs").then((n) => n.r),
    import("./start-CfM4Tfi7.mjs"),
