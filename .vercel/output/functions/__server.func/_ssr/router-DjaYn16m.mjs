...
const appCss = "/assets/styles-CUAUFIiC.css";
...
const $$splitComponentImporter$c = () => import("./skills-vwLF-kBv.mjs");
const Route$d = createFileRoute("/skills")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./services-C0itIrDb.mjs");
...
const $$splitComponentImporter$a = () => import("./resume-BB9fCzRZ.mjs");
...
const $$splitComponentImporter$8 = () => import("./photography-CtQ8CsPT.mjs");
const Route$8 = createFileRoute("/photography")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./experience-v4ePlNsE.mjs");
...
const $$splitComponentImporter$6 = () => import("./contact-BCPyO81I.mjs");
...
const $$splitComponentImporter$5 = () => import("./about-EVgyR1-b.mjs");
...
const $$splitComponentImporter$4 = () => import("./index-CLw72i2N.mjs");
...
const $$splitComponentImporter$3 = () => import("./index-CrPxrZsg.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-DTPstz3Y.mjs");
...
const $$splitComponentImporter$1 = () => import("./projects_._slug-BCagog4r.mjs");
...
const $$splitComponentImporter = () => import("./blog_._slug-DGLn2c2v.mjs");
...
const SkillsRoute = Route$d.update({
  id: "/skills",
  path: "/skills",
...
const PhotographyRoute = Route$8.update({
  id: "/photography",
  path: "/photography",
  getParentRoute: () => Route$e
});
