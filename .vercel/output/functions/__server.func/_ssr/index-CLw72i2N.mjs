...
import { a as site, u as urlFor, B as Button, s as sanityClient } from "./router-DjaYn16m.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-border/60", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose relative grid gap-12 py-20 md:grid-cols-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 rounded-xl border border-border/60 bg-muted/20 p-5 sm:p-6 backdrop-blur-sm max-w-2xl animate-fade-in", style: { animationDelay: "300ms" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-mono text-xs uppercase tracking-widest text-muted-foreground mb-4 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-1.5 rounded-full bg-signal" }),
            " Recruiter Summary"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4 text-sm text-foreground/90", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-foreground font-medium mb-1", children: "Current Focus:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Backend Engineering" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Cloud Computing" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "System Design" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-foreground font-medium mb-1", children: "Open To:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Software Engineering Roles" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Backend Engineering Roles" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Cloud Engineering Opportunities" })
              ] })
            ] })
          ] })
        ] }),
