import { t as t$1 } from "./decompress-response.mjs";
import r$3 from "url";
...
const e = !(typeof navigator > "u") && "ReactNative" === navigator.product, t = { timeout: e ? 6e4 : 12e4 }, r$2 = function(r2) {
...
const o$1 = ["request", "response", "progress", "error", "abort"], n = ["processOptions", "validateOptions", "interceptRequest", "finalizeOptions", "onRequest", "onResponse", "onError", "onReturn", "onHeaders"];
function r$1(s2, i2) {
  const c2 = [], a2 = n.reduce((e2, t2) => (e2[t2] = e2[t2] || [], e2), { processOptions: [r$2], validateOptions: [s$1] });
  function u2(e2) {
    const t2 = "object" == typeof e2 && e2.callSiteStack ? e2.callSiteStack : void 0, n2 = t2 ? void 0 : new Error(), r2 = o$1.reduce((e3, t3) => (e3[t3] = /* @__PURE__ */ (function() {
      const e4 = /* @__PURE__ */ Object.create(null);
      let t4 = 0;
      return { publish: function(t5) {
        for (const o2 in e4) e4[o2](t5);
      }, subscribe: function(o2) {
        const n3 = t4++;
        return e4[n3] = o2, function() {
          delete e4[n3];
        };
      } };
    })(), e3), {}), s3 = /* @__PURE__ */ ((e3) => function(t3, o2, ...n3) {
      const r3 = "onError" === t3;
      let s4 = o2;
      for (let o3 = 0; o3 < e3[t3].length && (s4 = (0, e3[t3][o3])(s4, ...n3), !r3 || s4); o3++) ;
      return s4;
    })(a2), c3 = s3("processOptions", e2);
    s3("validateOptions", c3);
    const u3 = { options: c3, channels: r2, applyMiddleware: s3 };
    let l2;
    const p2 = r2.request.subscribe((e3) => {
      l2 = i2(e3, (o2, i3) => ((e4, o3, i4) => {
        let c4 = e4, a3 = o3;
        if (!c4) try {
          a3 = s3("onResponse", o3, i4);
        } catch (e5) {
          a3 = null, c4 = e5;
        }
        if (c4 = c4 && s3("onError", c4, i4), c4) {
          if (c4 instanceof Error) {
            const e5 = t2?.stack || n2?.stack;
            if ("string" == typeof e5) {
              const o4 = e5.split("\n").slice(t2 ? 1 : 2);
              o4.length > 0 && (c4.stack += "\n" + o4.join("\n"));
            }
          }
          r2.error.publish(c4);
        } else a3 && r2.response.publish(a3);
      })(o2, i3, e3));
    });
    r2.abort.subscribe(() => {
      p2(), l2 && l2.abort();
    });
    const d2 = s3("onReturn", r2, u3);
    return d2 === r2 && r2.request.publish(u3), d2;
  }
  return u2.use = function(e2) {
  ...
  }, u2.clone = () => r$1(c2, i2), s2.forEach(u2.use), u2;
}
...
var f, m$1, y$1, _$1 = { exports: {} }, g$1 = /* @__PURE__ */ c$1((function() {
  ...
  y$1 = 1;
  var e2, t2, o2, a2 = r$3, h2 = a2.URL, p2 = s$2, d2 = n$3, l2 = require$$0$1.Writable, g2 = require$$5, b2 = (function() {
...
const w = ["protocol", "slashes", "auth", "host", "port", "hostname", "hash", "search", "query", "pathname", "path", "href"], x$1 = ["accept", "accept-charset", "accept-encoding", "accept-language", "accept-ranges", "cache-control", "content-encoding", "content-language", "content-location", "content-md5", "content-range", "content-type", "connection", "date", "expect", "max-forwards", "pragma", "referer", "te", "user-agent", "via"], q$1 = ["proxy-authorization"], E$1 = (e2) => null !== e2 && "object" == typeof e2 && "function" == typeof e2.pipe, O = "node", T$1 = (e2, t2, o2, r2, s2) => ({ body: s2, url: o2, method: r2, headers: e2.headers, statusCode: e2.statusCode || 0, statusMessage: e2.statusMessage || "", remoteAddress: t2 }), L = (e2, o2) => {
  const { options: i2 } = e2, c2 = Object.assign({}, r$3.parse(i2.url));
  ...
  const L2 = (function(e3) {
    ...
    })(r$3.parse(e3.url)) : e3.proxy;
    return "string" == typeof t2 ? r$3.parse(t2) : t2 || null;
  })(i2), k2 = L2 && (function(e3) {
    return typeof e3.tunnel < "u" ? !!e3.tunnel : "https:" === r$3.parse(e3.url).protocol;
  ...
  if (0 !== i2.maxRedirects && (_2.maxRedirects = i2.maxRedirects || 5), L2 && k2 ? _2 = (function(e3 = {}, t2) {
    ...
    })(Object.assign({}, t2, o3)), n2.href = `${n2.protocol}//${n2.host}${n2.path}`, n2.path = r$3.format(t2), n2;
  ...
  const S2 = e2.applyMiddleware("finalizeOptions", _2), $2 = B.request(S2, (o3) => {
    const r2 = o3.complete && 0 === o3.readableLength, s2 = C2 ? t$1(o3) : o3;
    H = s2;
